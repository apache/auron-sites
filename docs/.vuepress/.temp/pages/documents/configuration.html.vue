<template><div><h1 id="configurations-for-auron" tabindex="-1"><a class="header-anchor" href="#configurations-for-auron"><span>Configurations for Auron</span></a></h1>
<h2 id="auron-runtime-parameter" tabindex="-1"><a class="header-anchor" href="#auron-runtime-parameter"><span>Auron Runtime Parameter</span></a></h2>
...
<h2 id="native-operators-switch" tabindex="-1"><a class="header-anchor" href="#native-operators-switch"><span>Native Operators Switch</span></a></h2>
...
<h2 id="expression-udf-switch" tabindex="-1"><a class="header-anchor" href="#expression-udf-switch"><span>Expression/UDF switch</span></a></h2>
<table class="my-table3">
  <tr>
    <th>Parameters</th>
    <th>Default</th>
