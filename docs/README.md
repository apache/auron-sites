...
<div class="home-para">
  ...
  <div class="para-text">
    Apache Auron has passed all TPC-DS/TPC-H benchmark cases. Comparing to Apache Spark-3.5, Apache Auron is running ~2x faster and save ~50% cluster resources.
