import{_ as e,c as l,b as n,a as i,e as r,r as t,o as p}from"./app-ykDIiKk5.js";const c={};function d(o,s){const a=t("BenchmarkChart");return p(),l("div",null,[s[0]||(s[0]=n("h1",{id:"benchmarks",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#benchmarks"},[n("span",null,"Benchmarks")])],-1)),s[1]||(s[1]=n("h2",{id:"benchmark-result",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#benchmark-result"},[n("span",null,"Benchmark Result")])],-1)),s[2]||(s[2]=n("p",null,"Here is the benchmark result of TPC-DS 1TB Dataset, running under Spark-3.5.6 and Auron-6.0.0-preview (dc8d7a9).",-1)),i(a),s[3]||(s[3]=r(`<p>Below is a brief introduction of how we run TPC-DS benchmark with Spark/Auron.</p><h2 id="get-tpc-ds-tools" tabindex="-1"><a class="header-anchor" href="#get-tpc-ds-tools"><span>Get TPC-DS tools</span></a></h2><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">git clone https://github.com/auron-project/tpcds-tools</span>
