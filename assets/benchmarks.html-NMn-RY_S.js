import{_ as e,c as l,b as n,a as i,e as r,r as t,o as p}from"./app-7J7Vcg-Y.js";const c={};function d(o,s){const a=t("BenchmarkChart");return p(),l("div",null,[s[0]||(s[0]=n("h1",{id:"benchmarks",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#benchmarks"},[n("span",null,"Benchmarks")])],-1)),s[1]||(s[1]=n("h2",{id:"benchmark-result",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#benchmark-result"},[n("span",null,"Benchmark Result")])],-1)),s[2]||(s[2]=n("p",null,"Here is the benchmark result of TPC-DS 1TB Dataset, running under Apache Spark-3.5.6 and Apache Auron (Incubating)-6.0.0-preview (dc8d7a9).",-1)),i(a),s[3]||(s[3]=r(`<p>Below is a brief introduction of how we run TPC-DS benchmark with Apache Spark/Apache Auron (Incubating).</p><h2 id="get-tpc-ds-tools" tabindex="-1"><a class="header-anchor" href="#get-tpc-ds-tools"><span>Get TPC-DS tools</span></a></h2><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">git clone https://github.com/auron-project/tpcds-tools</span>
...
<span class="line">mvn package <span class="token parameter variable">-DskipTests</span></span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div></div></div><p>Edit your <code>$SPARK_HOME/conf/spark-default.conf</code> to enable/disable Apache Auron (Incubating) (see the following conf), then launch benchmark runner. If benchmarking with Apache Auron (Incubating), ensure that the Apache Auron (Incubating) jar package is correctly built and moved into <code>$SPARK_HOME/jars</code>. (<a href="https://github.com/apache/auron/#build-from-source" target="_blank" rel="noopener noreferrer">How to build Apache Auron (Incubating)?</a>)</p><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token comment"># use correct SPARK_HOME and data location</span></span>
